//
//  SyLottieAnimateContentView.swift
//  demoBySwift
//
//  Created by sxm on 2017/3/24.
...
class SyLottieAnimateBasicContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        iconColor = UIColor.init(red: 61 / 255.0, green: 206 / 255.0, blue: 27 / 255.0, alpha: 1.0)
...
class SyLottieAnimateContentView: SyLottieAnimateBasicContentView {
