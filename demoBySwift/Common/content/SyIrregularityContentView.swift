//
//  SyIrregularityContentView.swift
//  demoBySwift
//
...
class SyIrregularityBasicContentView: SyBouncesContentView {
...
class SyIrregularityContentView: ESTabBarItemContentView {
    ...
    public override func selectAnimation(animated: Bool, completion: (() -> ())?) {
        ...
        playMaskAnimation(animateView: view, target: self.imageView) { 
            [weak view] in
